...
<h3>3. Software Logic & Customization</h3>
...
3. In the "Additional Board Manager URLs" field, paste the following<br>
  URL: https://espressif.github.io/arduino-esp32/package_esp32_index.json.<br>
If you have other URLs in the field, separate them with a comma. <br>
...
**ALWAYS USE A DATA CABLE FOR CONNECTION AND NOT A POWER CABLE**

A data cable is essential for the ESP32 to transfer data, upload code, and monitor serial debugging, whereas "charge-only" cables will fail to connect the microcontroller to your computer
...
<h3>4. How to Modify the code:</h3>
...
<h3>5.  Troubleshooting & FAQ</h3>

**The code which I obtained was after many iterations of errors like HTTP 404,429 AND what not???, but this version absolutely works unless stuff happens....** <br>
- HTTP 404 Error: Ensure you are using the v1beta endpoint in your URL for the Flash model. <br> 
- HTTP 429 Error: You have exceeded your rate limit. Increase the delay between requests to at least 60 seconds. <br> 
- Blank Screen: Adjust the contrast potentiometer on Pin 3 until characters appear. <br>
___

📦 Parts Needed for the same

**PS: You can also use the 38 pin version but the code changes for it, you can modify my code to the required pins and try it.. I didn't have access to the 38 pin version by the way though..** <br>
0.ESP32-WROOM-32 (30-Pin Version) <br>

1.16x2 LCD Display (Blue/Green Backlight) anything works mate..<br>

2.10k Ohm Potentiometer (small or big pot, they work the same) <br>

3.Breadboard & Jumper Wires (get these mate)<br>
___
